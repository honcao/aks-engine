...
func setAzureStackCloudDefaults(a *Properties) {
	...
	if a.CloudProfile != nil {
		...
		if len(a.CloudProfile.AuthMethod) == 0 {
			a.CloudProfile.AuthMethod = AuthMethodClientSecret
		}
	}
}
...
func (cs *ContainerService) setOrchestratorDefaults(isUpdate bool) {
	...
	o.OrchestratorVersion = common.GetValidPatchVersion(
		o.OrchestratorType,
		o.OrchestratorVersion, isUpdate, a.HasWindows(), cs.Properties.GetCloudType())
...
func (cs *ContainerService) setDefaultCerts() (bool, []net.IP, error) {
	...
	if cs.Properties.IsAzureStackCloud() {
		allLocations = append(allLocations, cs.Location)
	}

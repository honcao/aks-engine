...
const exampleCustomHyperkubeImage = `example.azurecr.io/example/hyperkube:custom`
...
func TestGetKubernetesHyperkubeSpec(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedHyperkubeSpec: "k8s.gcr.io/hyperkube:v1.13.11",
		},
		{
			name:                  "1.16.0 Azure public cloud",
			properties:            &mock1dot16dot3,
			expectedHyperkubeSpec: "k8s.gcr.io/hyperkube:v1.16.0",
		},
		{
			name:                  "1.15.4 Azure Stack",
			properties:            &mock1dot15dot4azs,
			expectedHyperkubeSpec: "mcr.io/hyperkube:v1.15.4-azs",
		},
		{
			name:                  "Custom image",

...
func TestGetContainerServiceFuncMap(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			expectedGetHyperkubeImageReference: "hyperkube:v1.15.4",
		...
		},
		{
			...
			expectedGetHyperkubeImageReference: "hyperkube:v1.16.1",
		...
		},
		{
			...
			expectedGetHyperkubeImageReference: "hyperkube:v1.15.4-azs",
